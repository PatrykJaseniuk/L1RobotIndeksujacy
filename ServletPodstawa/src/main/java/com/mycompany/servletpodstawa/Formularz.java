...
public class Formularz extends HttpServlet {
    ...
    Formularz()
    {
        formularzHtml.addField("borys",new PoleHtml("text","imie",""));
//        formularzHtml.addField("borys1",new PoleHtml());
//        formularzHtml.addField("borys2",new PoleHtml());
//        formularzHtml.addField("borys3",new PoleHtml());
//        formularzHtml.addField("borys4",new PoleHtml());        
    }
    /**
